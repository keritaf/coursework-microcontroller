...
//lpm_mux DEVICE_FAMILY="Stratix III" LPM_SIZE=9 LPM_WIDTH=16 LPM_WIDTHS=4 data result sel
...
endmodule //element_mux_16x9_mux
//VALID FILE
...
module element_mux_16x9 (
	...
	wire [15:0] sub_wire0;
	wire [15:0] sub_wire10 = data0x[15:0];
	wire [15:0] sub_wire9 = data1x[15:0];
	wire [15:0] sub_wire8 = data2x[15:0];
	wire [15:0] sub_wire7 = data3x[15:0];
	wire [15:0] sub_wire6 = data4x[15:0];
	wire [15:0] sub_wire5 = data5x[15:0];
	wire [15:0] sub_wire4 = data6x[15:0];
	wire [15:0] sub_wire3 = data7x[15:0];
	wire [15:0] result = sub_wire0[15:0];
	wire [15:0] sub_wire1 = data8x[15:0];
	wire [143:0] sub_wire2 = {sub_wire10, sub_wire9, sub_wire8, sub_wire7, sub_wire6, sub_wire5, sub_wire4, sub_wire3, sub_wire1};

	element_mux_16x9_mux	element_mux_16x9_mux_component (
				.sel (sel),
				.data (sub_wire2),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL element_mux_16x9.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_mux_16x9.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_mux_16x9.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_mux_16x9.bsf TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_mux_16x9_inst.tdf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_mux_16x9_syn.v TRUE
