...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Stratix III" ENABLE_RUNTIME_MOD="NO" INIT_FILE="../memory-data/memory-ram.hex" NUMWORDS_A=4096 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="DONT_CARE" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 data_a q_a wren_a
...
module  lpm_ram_dq_8x4096_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_1.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_2.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_3.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_4.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_5.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_6.init_file = "../memory-data/memory-ram.hex",
	...
	defparam
		...
		ram_block1a_7.init_file = "../memory-data/memory-ram.hex",
...
endmodule //lpm_ram_dq_8x4096_altsyncram
//VALID FILE
...
module lpm_ram_dq_8x4096 (
	...
	lpm_ram_dq_8x4096_altsyncram	lpm_ram_dq_8x4096_altsyncram_component (
				.wren_a (wren),
				.clock0 (clock),
				.address_a (address),
				.data_a (data),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096.bsf TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096_inst.tdf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096_waveforms.html TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096_wave*.jpg FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_ram_dq_8x4096_syn.v TRUE
