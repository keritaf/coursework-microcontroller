...
// ============================================================
// File Name: element_ram_8x4096.v
// Megafunction Name(s):
// 			altsyncram
//
...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Stratix III" ENABLE_RUNTIME_MOD="YES" INIT_FILE="../memory-data/memory-ram.hex" INSTANCE_NAME="RAM" NUMWORDS_A=4096 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 data_a q_a wren_a
...
//altsyncram ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Stratix III" ENABLE_RUNTIME_MOD="NO" INDATA_ACLR_B="NONE" INDATA_REG_B="CLOCK1" INIT_FILE="../memory-data/memory-ram.hex" NUMWORDS_A=4096 NUMWORDS_B=4096 OPERATION_MODE="BIDIR_DUAL_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_ACLR_B="NONE" OUTDATA_REG_A="CLOCK0" OUTDATA_REG_B="UNREGISTERED" RDCONTROL_REG_B="CLOCK1" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 WIDTHAD_B=12 WRCONTROL_ACLR_B="NONE" WRCONTROL_WRADDRESS_REG_B="CLOCK1" address_a address_b clock0 clock1 data_a data_b q_a q_b wren_a wren_b
//VERSION_BEGIN 9.1 cbx_altsyncram 2009:10:21:21:22:16:SJ cbx_cycloneii 2009:10:21:21:22:16:SJ cbx_lpm_add_sub 2009:10:21:21:22:16:SJ cbx_lpm_compare 2009:10:21:21:22:16:SJ cbx_lpm_decode 2009:10:21:21:22:16:SJ cbx_lpm_mux 2009:10:21:21:22:16:SJ cbx_mgl 2009:10:21:21:37:49:SJ cbx_stratix 2009:10:21:21:22:16:SJ cbx_stratixii 2009:10:21:21:22:16:SJ cbx_stratixiii 2009:10:21:21:22:16:SJ cbx_util_mgl 2009:10:21:21:22:16:SJ  VERSION_END
...
module  element_ram_8x4096_altsyncram1
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	stratixiii_ram_block   ram_block3a_0
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_0.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_0.init_file_layout = "port_a",
		ram_block3a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_0.mem_init0 = 2048',
		...
		ram_block3a_0.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_1
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_1.init_file = "../memory-data/memory-ram.hex",
		...
		ram_block3a_1.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_2
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_2.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_2.init_file_layout = "port_a",
		ram_block3a_2.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_2.mem_init0 = 2048',
		...
		ram_block3a_2.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_3
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_3.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_3.init_file_layout = "port_a",
		ram_block3a_3.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_3.mem_init0 = 2048',
		...
		ram_block3a_3.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_4
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_4.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_4.init_file_layout = "port_a",
		ram_block3a_4.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_4.mem_init0 = 2048',
		...
		ram_block3a_4.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_5
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_5.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_5.init_file_layout = "port_a",
		ram_block3a_5.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_5.mem_init0 = 2048',
		...
		ram_block3a_5.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_6
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_6.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_6.init_file_layout = "port_a",
		ram_block3a_6.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_6.mem_init0 = 2048',
		...
		ram_block3a_6.lpm_type = "stratixiii_ram_block";
	stratixiii_ram_block   ram_block3a_7
	( 
	.clk0(clock0),
	.clk1(clock1),
	.dftout(),
	...
	defparam
		...
		ram_block3a_7.init_file = "../memory-data/memory-ram.hex",
		ram_block3a_7.init_file_layout = "port_a",
		ram_block3a_7.logical_ram_name = "ALTSYNCRAM",
		ram_block3a_7.mem_init0 = 2048',
		...
		ram_block3a_7.lpm_type = "stratixiii_ram_block";
	assign
...
endmodule //element_ram_8x4096_altsyncram1

//synthesis_resources = ram_bits (AUTO) 32768 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  element_ram_8x4096_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	element_ram_8x4096_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	defparam
		...
		mgl_prim2.node_name = 1380011264,
	...
	assign
		q_a = wire_altsyncram1_q_a;
endmodule //element_ram_8x4096_altsyncram
//VALID FILE
...
module element_ram_8x4096 (
	...
	element_ram_8x4096_altsyncram	element_ram_8x4096_altsyncram_component (
				.wren_a (wren),
				.clock0 (clock),
				.address_a (address),
				.data_a (data),
...
// Retrieval info: PRIVATE: MIFfilename STRING "../memory-data/memory-ram.hex"
...
// Retrieval info: CONSTANT: INIT_FILE STRING "../memory-data/memory-ram.hex"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096.bsf TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096_inst.tdf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096_waveforms.html TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096_wave*.jpg FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL element_ram_8x4096_syn.v TRUE
